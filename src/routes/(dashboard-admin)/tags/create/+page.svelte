<script lang="ts">
	...
	const createdSuccessNotification: Notification = {
		...
		message: 'A nova tag foi adicionada ao sistema',
		type: 'success'
	};
</script>

<svelte:head>
	<title>iForal - Nova tag</title>
</svelte:head>
				...
				<div class="mt-5 md:mt-0 md:col-span-2">
					<div class="grid grid-cols-12 gap-6 card p-6">
						<div class="col-span-12 lg:col-span-6">
							...
							<input id="name" name="name" class="input mt-1" type="text" placeholder="pb" />
						</div>
						<div class="col-span-12 lg:col-span-6">
						...
						<div class="col-span-12">
							...
							<InputList id="attributes" bind:addingValues={addingAttribute}>
