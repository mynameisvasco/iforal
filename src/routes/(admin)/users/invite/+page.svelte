<script lang="ts">
	...
	const invitedSuccessNotification: Notification = {
		title: 'Invite enviado',
		message: 'O utilizador foi convidado a entrar na plataforma',
		type: 'success'
	};
</script>

<svelte:head>
	<title>iForal - Convidar utilizador</title>
</svelte:head>
...
<main>
	<div class="page-body mt-12">
		<form
			...
			method="POST"
			use:enhance={formHandler(invitedSuccessNotification)}
		>
			<div class="md:grid md:grid-cols-3 md:gap-6">
				<div class="md:col-span-1">
					<h3 class="title-2">Detalhes</h3>
					<p class="mt-1 label">
						Conjunto de informações pertencentes ao utilizador a ser convidado
					</p>
				</div>
